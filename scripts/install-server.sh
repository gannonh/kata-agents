#!/usr/bin/env bash
# install-server.sh — Set up the Kata Agent standalone server.
#
# Usage:
...
echo ""
echo "===================================="
echo "  Kata Agent Server Ready"
echo "===================================="
echo ""
echo "Start the server (with Web UI):"
echo ""
echo "  KATA_SERVER_TOKEN=$TOKEN \\"
echo "  KATA_WEBUI_DIR=$REPO_ROOT/apps/webui/dist \\"
echo "  KATA_BUNDLED_ASSETS_ROOT=$REPO_ROOT/apps/electron \\"
...
echo "  KATA_WEBUI_DIR=$REPO_ROOT/apps/webui/dist \\"
echo "  KATA_BUNDLED_ASSETS_ROOT=$REPO_ROOT/apps/electron \\"
echo "  KATA_RPC_HOST=0.0.0.0 \\"
echo "  KATA_RPC_PORT=9100 \\"
echo "  bun run $REPO_ROOT/packages/server/src/index.ts"
echo ""
...
echo "  KATA_WEBUI_DIR=$REPO_ROOT/apps/webui/dist \\"
echo "  KATA_BUNDLED_ASSETS_ROOT=$REPO_ROOT/apps/electron \\"
echo "  KATA_RPC_TLS_CERT=/path/to/cert.pem \\"
echo "  KATA_RPC_TLS_KEY=/path/to/key.pem \\"
echo "  bun run $REPO_ROOT/packages/server/src/index.ts"
echo ""
