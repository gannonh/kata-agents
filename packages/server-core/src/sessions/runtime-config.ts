import type { AgentProvider, LlmAuthType } from '@kata-sh/shared/agent/backend'
import { isCompatProvider, modelSupportsImages, type LlmConnection } from '@kata-sh/shared/config'
import type { FileAttachment } from '@kata-sh/shared/protocol'
