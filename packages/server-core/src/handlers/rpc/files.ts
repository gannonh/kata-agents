...
import { RPC_CHANNELS, type FileAttachment, type DirectoryListingResult } from '@kata-sh/shared/protocol'
import type { StoredAttachment } from '@kata-sh/core/types'
import { readFileAttachment, validateImageForClaudeAPI, IMAGE_LIMITS } from '@kata-sh/shared/utils'
import { getSessionAttachmentsPath, validateSessionId } from '@kata-sh/shared/sessions'
import { getWorkspaceByNameOrId } from '@kata-sh/shared/config'
import { resizeImageForAPI, inspectImageBuffer } from '@kata-sh/server-core/services'
import { sanitizeFilename, validateFilePath, getWorkspaceAllowedDirs } from '@kata-sh/server-core/handlers'
