...
import type { PushTarget } from '@kata-sh/shared/protocol'
import type { CredentialManager } from '@kata-sh/shared/credentials'
import type {
  ISessionManager,
...
export interface MessagingGatewayRegistryOptions {
  ...
  whatsapp?: {
    /** Absolute path to the worker entry (packaged/unpacked from @kata-sh/messaging-whatsapp-worker). */
    workerEntry: string
