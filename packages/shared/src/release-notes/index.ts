 ...
 *
 * Loads release notes from bundled assets and syncs them to ~/.kata-agents/release-notes/.
...
function loadBundledReleaseNotes(): Record<string, string> {
  ...
  // Try bundled assets first, fall back to ~/.kata-agents/release-notes/
  // (Docker/remote server may not have KATA_BUNDLED_ASSETS_ROOT set,
