 ...
 *
 * The mapping lives in ~/.kata-agents/tool-icons/tool-icons.json alongside the
 ...
 *
 * @param toolIconsDir - Path to the tool-icons directory (e.g. ~/.kata-agents/tool-icons/)
 ...
 *
 * @param commandStr - Full bash command string, e.g. "git add . && npm publish"
 * @param toolIconsDir - Path to ~/.kata-agents/tool-icons/ containing tool-icons.json and icon files
