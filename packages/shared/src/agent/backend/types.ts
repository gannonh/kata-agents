 ...
 * The KataAgent facade delegates to these backends, enabling provider switching while
 ...
 * - AsyncGenerator for streaming: Consistent with existing KataAgent API
 */
 ...
 * 2. Enable the facade pattern in KataAgent
...
export interface AgentBackend {
   ...
   * (kata-agents-oss#804). Set by SessionManager after a successful mid-turn
