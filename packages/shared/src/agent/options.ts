...
declare const KATA_AGENT_CLI_VERSION: string | undefined;
...
export function getDefaultOptions(envOverrides?: Record<string, string>): Partial<Options> {
    ...
    if (typeof KATA_AGENT_CLI_VERSION !== 'undefined' && KATA_AGENT_CLI_VERSION != null) {
        const baseDir = join(homedir(), '.local', 'share', 'craft', 'versions', KATA_AGENT_CLI_VERSION);
        return {
