 ...
 * Extracted here so handler code in @kata-sh/server-core can import
 * from @kata-sh/shared/protocol without reaching into the app.
 */
...
export { generateMessageId } from '@kata-sh/core/types'
