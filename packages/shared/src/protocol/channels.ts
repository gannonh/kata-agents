...
export const RPC_CHANNELS = {
  ...
  bots: {
    ...
    GET_MEMORY: 'bots:getMemory',
    GET_CONTEXT: 'bots:getContext',
    MUTATE_MEMORY: 'bots:mutateMemory',
  ...
  channels: {
    ...
    REOPEN: 'channels:reopen',
    DELETE: 'channels:delete',
    ADD_MEMBER: 'channels:addMember',
    REMOVE_MEMBER: 'channels:removeMember',
    GET_JOURNAL: 'channels:getJournal',
  ...
  browserPane: {
    ...
    HIDE: 'browser-pane:hide',
    DETACH: 'browser-pane:detach',
    ATTACH: 'browser-pane:attach',
    SET_BOUNDS: 'browser-pane:set-bounds',
