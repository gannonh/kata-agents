...
export const LOCAL_ONLY_CHANNELS = new Set<string>([
  ...
  RPC_CHANNELS.appearance.EXPAND_TOOL_ACTIVITY_BY_DEFAULT_CHANGED,
  ...
  RPC_CHANNELS.browserPane.ANNOTATION_STATE_CHANGED,
...
export const REMOTE_ELIGIBLE_CHANNELS = new Set<string>([
  ...
  // channels — ChannelDirectory + ChannelRouter
