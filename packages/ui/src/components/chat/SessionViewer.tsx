...
import type { StoredSession } from '@kata-sh/core'
...
/**
 * KataAgentLogo - The Kata Agent "C" logo for branding
 */
function KataAgentLogo({ className }: { className?: string }) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
        ...
        >
          <div className="h-full overflow-y-auto">
            ...
            <div className={CHAT_CLASSES.brandingContainer}>
              <KataAgentLogo className="w-8 h-8 text-[#9570BE]/40" />
            </div>
            </div>
          </div>
        </div>
