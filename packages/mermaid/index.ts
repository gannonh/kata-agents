...
<head>
  ...
  <meta property="og:url" content="https://github.com/gannonh/kata-desktop" />
  ...
  <!-- Analytics disabled for Kata Desktop fork -->
...
<body>
  ...
  <div class="theme-bar" id="theme-bar">
    <div class="brand-badge-wrapper">
      ...
      <div class="brand-dropdown shadow-modal-small" id="brand-dropdown">
        <a href="https://github.com/gannonh/kata-desktop" class="brand-dropdown-item" target="_blank" rel="noopener">
          ...
          <span style="margin-left: -2px;">Kata Desktop<span class="tagline">AI Agent Platform</span></span>
        </a>
  ...
  <header class="hero-header">
    ...
    <p class="hero-description">
      ...
      Originally built by the team at <a href="https://craft.do" target="_blank" rel="noopener">Craft</a> — because diagrams deserve great design too.
    </p>
    <div class="hero-buttons">
      <a href="https://github.com/gannonh/kata-desktop" target="_blank" rel="noopener" class="hero-btn hero-btn-primary">
...
${bundleJs}
  ...
  <footer class="site-footer">
    ...
    <div class="footer-links">
      <a href="https://github.com/gannonh/kata-desktop/issues">Issues</a>
