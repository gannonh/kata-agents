...
Shared TypeScript types and utilities for Kata Agent applications.

## Installation

```bash
# In a workspace package
bun add @kata-sh/core
```
...
// Import utilities
import { generateMessageId, debug } from '@kata-sh/core';
```
...
- `AgentEvent` - Events from KataAgent
