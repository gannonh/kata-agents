...
* **Approved, awaiting Build: Worktree V2**: epic [#17](https://github.com/gannonh/kata-agents/issues/17) and sequential phases [#40](https://github.com/gannonh/kata-agents/issues/40), [#41](https://github.com/gannonh/kata-agents/issues/41), [#42](https://github.com/gannonh/kata-agents/issues/42), and [#43](https://github.com/gannonh/kata-agents/issues/43) cover custom identity, server-owned settings, snapshot-backed lifecycle, checkout handoff, and isolated conversation forks. Build has not started.
