...
* **Awaitable agent teardown quiescence** — [specs/2026-07-30-agent-quiescence-contract-design.md](specs/2026-07-30-agent-quiescence-contract-design.md) — **Draft, awaiting approval.** Plans the required backend contract from [#21](https://github.com/gannonh/kata-agents/issues/21) so destructive managed-worktree operations wait for nested turn completion and provider child-process exit rather than processing-flag polling and a fixed grace delay.
