...
* **Worktree V2 Phase 2** — [#41](https://github.com/gannonh/kata-agents/issues/41) — snapshot-backed management and automatic cleanup: verified capture/restore, per-server auto-delete policy, LRU retention sweeps, path leases and journal recovery, recovery UI, and session-delete integration.
