...
* **Pi SDK 0.83 migration** — [specs/2026-08-01-pi-sdk-0.83-migration-design.md](specs/2026-08-01-pi-sdk-0.83-migration-design.md) — **Approved.** Migrate the embedded Pi runtime from retired `@mariozechner` packages to the current Pi CLI-aligned `@earendil-works` packages and adopt native model reasoning metadata.
