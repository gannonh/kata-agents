...
export const CHANNEL_MAP = {
  ...
  // Bots
  listBots: invoke(RPC_CHANNELS.bots.LIST),
  getBot: invoke(RPC_CHANNELS.bots.GET),
  createBot: invoke(RPC_CHANNELS.bots.CREATE),
  renameBot: invoke(RPC_CHANNELS.bots.RENAME),
  updateBot: invoke(RPC_CHANNELS.bots.UPDATE),
  hideBot: invoke(RPC_CHANNELS.bots.HIDE),
  archiveBot: invoke(RPC_CHANNELS.bots.ARCHIVE),
  reopenBot: invoke(RPC_CHANNELS.bots.REOPEN),
  getBotJournal: invoke(RPC_CHANNELS.bots.GET_JOURNAL),
  getBotMemory: invoke(RPC_CHANNELS.bots.GET_MEMORY),
  getBotContext: invoke(RPC_CHANNELS.bots.GET_CONTEXT),
  mutateBotMemory: invoke(RPC_CHANNELS.bots.MUTATE_MEMORY),
  sendBotMessage: invoke(RPC_CHANNELS.bots.SEND_MESSAGE),
  ...
  renameChannel: invoke(RPC_CHANNELS.channels.RENAME),
  archiveChannel: invoke(RPC_CHANNELS.channels.ARCHIVE),
  reopenChannel: invoke(RPC_CHANNELS.channels.REOPEN),
  deleteChannel: invoke(RPC_CHANNELS.channels.DELETE),
  addChannelMember: invoke(RPC_CHANNELS.channels.ADD_MEMBER),
  removeChannelMember: invoke(RPC_CHANNELS.channels.REMOVE_MEMBER),
  getChannelJournal: invoke(RPC_CHANNELS.channels.GET_JOURNAL),
  ...
  getGitCapabilities: invoke(RPC_CHANNELS.git.GET_CAPABILITIES),
  getGitWorktreeSettings: invoke(RPC_CHANNELS.git.GET_WORKTREE_SETTINGS),
  updateGitWorktreeSettings: invoke(RPC_CHANNELS.git.UPDATE_WORKTREE_SETTINGS),
  ...
  'browserPane.attachToPanel': invoke(RPC_CHANNELS.browserPane.ATTACH),
  'browserPane.setPanelBounds': invoke(RPC_CHANNELS.browserPane.SET_BOUNDS),
