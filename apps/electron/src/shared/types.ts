...
export interface ElectronAPI {
  ...
  getPiProviderModels(provider: string): Promise<{ models: Array<{ id: string; name: string; costInput: number; costOutput: number; contextWindow: number; reasoning: boolean; supportedThinkingLevels?: ThinkingLevel[] }>; totalCount: number }>
  ...
  onExpandToolActivityByDefaultChange(callback: (enabled: boolean) => void): () => void
