...
mock.module('@kata-sh/shared/config', () => ({
...
mock.module('@kata-sh/shared/workspaces', () => ({
  loadWorkspaceConfig: () => ({
    defaults: {
      permissionMode: 'ask',
      thinkingLevel: 'medium',
...
mock.module('@kata-sh/shared/agent', () => ({
...
mock.module('@kata-sh/shared/agent/backend', () => ({
...
mock.module('@kata-sh/shared/sources', () => ({
...
mock.module('@kata-sh/shared/automations', () => ({
...
mock.module('@kata-sh/shared/sessions', () => ({
  listSessions: () => [],
...
const { SessionManager } = await import('@kata-sh/server-core/sessions')
