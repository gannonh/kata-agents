...
import { extractWorkspaceSlugFromPath } from '@kata-sh/shared/utils/workspace-slug'
import { DEFAULT_THINKING_LEVEL } from '@kata-sh/shared/agent/thinking-levels'
...
export default function App() {
  ...
  useEffect(() => {
    const initialize = async () => {
      try {
        ...
        if (needs.isFullyConfigured) {
          // If no workspace is selected (thin client without KATA_WORKSPACE_ID),
  ...
  // Platform actions for @kata-sh/ui components (overlays, etc.)
