...
import { KataAgentsSymbol } from '../icons/KataAgentsSymbol'
...
/**
 * Mobile AppMenu — Kata logo trigger that opens a full-screen, navigation-stack sheet.
 *
...
export function MobileAppMenu(props: AppMenuProps) {
  ...
  return (
    <>
      ...
      >
        <KataAgentsSymbol className="!h-5 !w-auto text-accent" />
      </TopBarButton>
      <MobileMenuSheet
        state={state}
        pages={pages}
