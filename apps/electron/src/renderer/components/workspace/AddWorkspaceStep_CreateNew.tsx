 ...
 * - Location: Default (~/.kata-agents/workspaces/) or Custom
 */
export function AddWorkspaceStep_CreateNew({
  ...
  const defaultBasePath = homeDir ? `${homeDir}/.kata-agents/workspaces` : '~/.kata-agents/workspaces'
      ...
      <div className="mt-6 w-full space-y-6">
        ...
        <div className="space-y-3">
          ...
          <AddWorkspace_RadioOption
            ...
            subtitle="under .kata-agents folder"
          />
