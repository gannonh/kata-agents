...
import { getDocUrl, type DocFeature } from '@kata-sh/shared/docs/doc-links'
...
export function SidebarMenu({
  ...
  if (type === 'newSession') {
    return (
      <MenuItem onClick={() => window.electronAPI.openUrl('kataagents://action/new-session?window=focused')}>
