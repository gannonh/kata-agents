...
import { AppSettingsPage, AppearanceSettingsPage, WorkspaceSettingsPage, ChannelSettingsPage, PermissionsSettingsPage, LabelsSettingsPage, PreferencesPage, ShortcutsPage, SourceInfoPage, ChatPage } from '@/pages'
