...
import { PERMISSION_MODE_CONFIG, type PermissionMode } from '@kata-sh/shared/agent/modes'
import type { BackgroundTask } from './ActiveTasksBar'
import { LabelIcon, LabelValueTypeIcon } from '@/components/ui/label-icon'
import { LabelValuePopover } from '@/components/ui/label-value-popover'
import type { LabelConfig } from '@kata-sh/shared/labels'
import { flattenLabels, parseLabelEntry, formatLabelEntry, formatDisplayValue } from '@kata-sh/shared/labels'
