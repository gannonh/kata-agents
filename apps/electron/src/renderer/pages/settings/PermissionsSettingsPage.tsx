 ...
 * Shows both default patterns (from ~/.kata-agents/permissions/default.json)
 * and custom workspace additions (from workspace permissions.json).
 *
 * Default patterns can be edited by the user in ~/.kata-agents/permissions/default.json.
...
/**
 * Build default permissions data from ~/.kata-agents/permissions/default.json.
                      ...
                      {defaultPermissionsData.length > 0 ? (
                        ...
                        <div className="p-8 text-center text-muted-foreground">
                          ...
                          <p className="text-xs mt-1 text-foreground/40">
                            Default permissions should be at <code className="bg-foreground/5 px-1 rounded">~/.kata-agents/permissions/default.json</code>
                          </p>
                        </div>
                      )}
                    </SettingsCard>
