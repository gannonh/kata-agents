 ...
 * PreferencesPage
 *
 * Form-based editor for stored user preferences (~/.kata-agents/preferences.json).
 * Features:
    ...
    <div className="h-full flex flex-col">
      ...
      <div className="flex-1 min-h-0 mask-fade-y">
        <ScrollArea className="h-full">
          ...
          <SettingsSection
            title="Basic Info"
            description="Help Kata Agents personalize responses to you."
          >
            <SettingsCard divided>
              <SettingsInput
                label="Name"
                description="How Kata Agents should address you."
              ...
              <SettingsInput
                label="Language"
                description="Preferred language for Kata Agents's responses."
          ...
          <SettingsSection
            title="Notes"
            description="Free-form context that helps Kata Agents understand your preferences."
            action={
          ...
          >
            <SettingsCard divided={false}>
              <SettingsTextarea
                ...
                placeholder="Any additional context you'd like Kata Agents to know..."
                rows={5}
                inCard
              />
            </SettingsCard>
