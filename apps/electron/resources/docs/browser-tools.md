...
Use `browser_tool` to control built-in browser windows (Chromium) inside Kata Agents.
...
- Before first browser tool usage, the agent must read this guide (`~/.kata-agents/docs/browser-tools.md`).
