...
4. Also update any "Craft Agents" text strings to "Kata Agents" in these components.
  </action>
  <verify>
...
Note: The VIEWER_URL is cleared because agents.craft.do won't work for Kata Agents. This will be re-enabled when kata.sh viewer is available.
  </action>
  <verify>
