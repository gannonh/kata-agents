...
<objective>
Document the upstream management strategy for maintaining Kata Agents as a fork of Craft Agents.
...
Brief intro: Kata Agents is a fork of Craft Agents. This document describes how to track and selectively adopt upstream changes.
